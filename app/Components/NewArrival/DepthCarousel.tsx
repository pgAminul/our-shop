...
<div className="md:max-w-7xl  mx-auto px-4 sm:px-6 lg:px-8 py-8">
   {/* Header */}
        <div className="md:py-4 md:mb-15 ">
          <div className="mb-3 flex items-center gap-2">
            <span>
                     
          <FaCamera size={28} style={{ 
    ...
    <div className="absolute inset-0 [transform-style:preserve-3d]" ref={stageRef}>
      {data.map((item, i) => (
        ...
        >
          ...
          {/* টেক্সট ওভারলে - ইমেজের একেবারে নিচে */}
          <div className="absolute inset-0 pointer-events-none">
            ...
            {/* টেক্সট কন্টেন্ট - একেবারে নিচে */}
            <div className="absolute bottom-0 left-0 right-0 p-4">
              {item.title && (
                <h3 className="text-white text-center text-lg font-bold drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]">
                  {item.title}
                </h3>
              )}
              {item.description && (
                <p className="text-white/90 text-center text-sm mt-1 drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]">
                  {item.description}
                </p>
              )}
            </div>
